...
本项目是遵循 **Open Agent Skills** 规范的 skill 开发项目。
$literature-match，用于将 Markdown 文档中的参考文献条目匹配到本地 Zotero（Better BibTeX 导出）条目，并生成 `match_result.json`（不修改原文档）。
skill 发布包位于 `literature-match` 目录。
